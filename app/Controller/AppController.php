...
//        setcookie('SES_TYPE', '', -1, '/', DOMAIN_COOKIE, false, false);
    ...
    public function beforeFilter() {
        ...
        if($this->Auth->User("id")) {
            ...
            $this->Auth->allow('index','license','login','validate_emailurl','forgotpassword','session_maintain','googleConnect', 'googleSignup', 'setGoogleInfo','ajaxpostcase','ajaxemail','register_user','invitation','emailUpdate');
