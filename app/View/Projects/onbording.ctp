...
<div class="steps_os">
    <div class="steps_usr">
        <h2 style="font-size: 22px; color: rgb(91, 50, 180);">Welcome <?php echo USERNAME; ?>!<br/> </h2><!--Get started with your COMPANY_NAME account</h1>-->
...
<!--						<th>
            ...
            <td class="onbrd_rt">
				...
				<?php if(!$is_active_proj){?>					
                    <span style="text-shadow:none; font-size: 26px;text-align:center">Create your first project, and get started<br/></span>
                    <button  type="button"class="btn submit-btn" <?php if(ACCOUNT_STATUS!=2){?> onclick="newProject('menupj', 'loaderpj');" <?php }?>>
				...
				<?php }elseif($totalusers<=1){?>
                    ...
                    <button  type="button"class="btn submit-btn"<?php if(ACCOUNT_STATUS!=2){?> onclick="newUser('menuid1', 'loaderid1');" <?php }?>>					
                        <img src="<?php echo HTTP_ROOT;?>img/wright_icon.png" />
                        Invite User
                    </button>
				...
				<?php }*/elseif((!isset($task_crted)) || ($task_crted==0)){ ?>
                    ...
                    <button  type="button"class="btn submit-btn" onclick="creatask();">
                        <img src="<?php echo HTTP_ROOT;?>img/wright_icon.png" />Create Task
                    </button>
