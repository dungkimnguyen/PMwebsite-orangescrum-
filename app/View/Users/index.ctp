...
echo $this->Html->css('css/responsive');?>
</head>
<body>
    <!-- ***** Header Area Start ***** -->
...
<!--<h4>Welcome to COMPANY_NAME Community Edition v0.1</h4>-->
                ...
                <div class="col-12 col-lg-2">
                    <div class="sing-up-button d-none d-lg-block">
                        <a href="<?php echo HTTP_ROOT; ?>users/login/new" >Sign Up Free</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md">
                    ...
                    <div class="get-start-area">
                        ...
                        <form action="#" method="post" class="form-inline">
                           ...
                           <a href="<?php echo HTTP_ROOT; ?>users/login/" > <input type="button" class="submit" value="Sign In"></a>
                            <a href="<?php echo HTTP_ROOT; ?>users/login/new" ><input type="button" class="submit" value="Get Started"></a>
                        </form>
                        <!-- Form End -->
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="special_description_img">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/bg-img/special.png" alt="">
                        </div>
                    </div>
    ...
    <div class="video-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Video Area Start -->
                    <div class="video-area" style="background-image: url(<?php echo HTTP_ROOT; ?>img/img/bg-img/video.jpg);">
                ...
                <div class="col-12">
                    ...
                    <div class="app_screenshots_slides owl-carousel">
                        <div class="single-shot">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/scr-img/app-11.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/scr-img/app-21.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/scr-img/app-31.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/scr-img/app-41.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/scr-img/app-51.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/scr-img/app-31.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="slider slider-nav">
                        <div class="client-thumbnail">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/bg-img/client-3.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/bg-img/client-2.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/bg-img/client-1.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/bg-img/client-2.jpg" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/team-img/team-1.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/team-img/team-2.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/team-img/team-3.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="<?php echo HTTP_ROOT; ?>img/img/team-img/team-4.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
    ...
    <footer class="footer-social-icon text-center section_padding_70 clearfix">
        ...
        <div class="copyright-text">
            ...
            <p>Copyright ©2017. Designed by <a href="https://tabula.com" target="_blank">Tabula</a></p>
        </div>
    </footer>
    <!-- ***** Footer Area Start ***** -->

    <!-- Jquery-2.2.4 JS -->
    <script src="<?php echo JS_PATH; ?>js/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="<?php echo JS_PATH; ?>js/popper.min.js"></script>
    <!-- Bootstrap-4 Beta JS -->
    <script src="<?php echo JS_PATH; ?>js/bootstrap.min.js"></script>
    <!-- All Plugins JS -->
    <script src="<?php echo JS_PATH; ?>js/plugins.js"></script>
    <!-- Slick Slider Js-->
    <script src="<?php echo JS_PATH; ?>js/slick.min.js"></script>
    <!-- Footer Reveal JS -->
    <script src="<?php echo JS_PATH; ?>js/footer-reveal.min.js"></script>
    <!-- Active JS -->
    <script src="<?php echo JS_PATH; ?>js/active.js"></script>
</body>
</html>
