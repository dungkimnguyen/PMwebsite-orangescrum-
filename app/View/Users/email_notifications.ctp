...
<tr>
		...
		<button type="button" value="Save" name="submit_Pass"  id="submit_Pass" class="btn submit-btn" onclick="checkCsrfToken('UserNotificationEmailNotificationsForm');"><i class="icon-big-tick"></i>Update</button>
