...
<?php if(CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "chart" || PAGE_NAME == "hours_report")) { ?>
	...
	<li  class="kanbn dashborad-view-type" id="select_view_mlst" style="display: none;">
		...
		<button style="margin-left:25px;" onclick="addEditMilestone(this);" id="mlist_crt_mlstbtn" type="button" value="Create Milestone" class="btn submit-btn">    Create Milestone   </button>
	</li>
